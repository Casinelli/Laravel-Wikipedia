...
* - getExtractsChars()
* - setExtractsChars()
* - getExtractsSentences()
* - setExtractsSentences()
* - getTitles()
* - setTitles()
* - getExtractsPlainText()
* - setExtractsPlainText()
* Classes list:
* - QueryBuilder
*/
...
class QueryBuilder
{
     ...
     * @var array
     */
    protected $queryPrivate = ['action' => 'query', 'prop' => 'extracts', ];
